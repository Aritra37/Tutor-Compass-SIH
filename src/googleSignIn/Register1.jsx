  ...
  const logOut = async () => {
    ...
    return (
        <div className="SignIn">
            ...
            <div className="seq2">
            <img src={Saly1} alt="kidOnRocket" className="kidOnRocket" width="300px" height="300px" style={{paddingTop:"0"}} onClick={logOut} />
            </div>
            <div className="seq3">
                <div className="seq31">
                ...
                <div className="credentials">
                    ...
                    <button type="submit" className="buttonSignIn" onClick={signIn}>Register</button>
                    </form>
                </div>
